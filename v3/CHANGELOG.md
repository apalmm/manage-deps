...
- run with `python3 -m myapp [pkg name]`
...
### **v1.1.4 — Styling updates and perfecting + new name**

- Various styling fixes
- Actual function dependency path highlighted in blue
- Fade out all unneccesary nodes
- Updated legend to include new path
- flask --app R_function_dependency_app run

to start server after navigating to selected folder

then in a separate terminal run:

python3 -m R_function_dependency_app [pkg name]
with your package name that you wish to analyze
